...
*** Editor Plugins
**** Plugin Script
#+BEGIN_SRC snippet :tangle "snippets/godot-gdscript-mode/plugin_script"
# -*- mode: snippet -*-
# contributor: Franco Eusébio Garcia
# group: Editor Plugin
# name: Editor Plugin Script
# key: plugin_script
# expand-env: ((yas-indent-line 'fixed))
# --
...
func _enter_tree():
    ...
    add_custom_type("$2", ${5:"TypeName"}, preload("${6:script}.gd"), preload("${7:icon}.png"))
