...
#+BEGIN_SRC emacs-lisp :results output
;; From <https://github.com/caiorss/Emacs-Elisp-Programming#http-and-post-request>
...
(progn
  ...
  ;; (princ PORT)
  ;; (print JSON_CONTENT)
  ;; (princ (concat "http://localhost:" (replace-regexp-in-string "\n\\'" "" PORT) " HTTP/1.1"))
  ;;(print (json-read-from-string JSON_CONTENT))

  (princ (url-http-post (concat "http://localhost:" (replace-regexp-in-string "\n\\'" "" PORT))
                 JSON_CONTENT))
)
#+END_SRC
