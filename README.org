...
#+BEGIN_SRC emacs-lisp
(defun company-godot-gdscript-process-request-completion-at-point ()
  "Build and send the request for completion at the current point in buffer.

Returns a JSON file containing the hint, suggestions, and prefix
offered by GD Auto-Complete Service, if any."
