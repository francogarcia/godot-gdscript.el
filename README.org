...
Auto-completion is currently a work in progress; although basic features are
working, they require external tools and some configuration.
...
** Auto-Completion
*NOTE*: Add this moment, auto-completion requires Curl (installed and exported
to the system's path) and was only tested in Linux.
...
Emacs, [[https://github.com/dryman/toml-mode.el][toml-mode.el: Emacs Major mode for editing TOML files]].
...
**** Setup
#+BEGIN_SRC snippet :tangle "snippets/godot-gdscript-mode/.yas-setup.el"
# (add-hook godot-gdscript-mode-hook
#           '(lambda () (set (make-local-variable 'yas-indent-line) 'fixed)))
#+END_SRC
...
# key: forr
# --
for ${1:variable} in range(${2:start, end, increment}):
$0
#+END_SRC
...
**** TODO Attribute with Set Method
...
**** TODO Attribute with Get Method
Add the line with the correct indentation.
...
**** TODO Attribute with Get and Set Method
Add the line with the correct indentation.
